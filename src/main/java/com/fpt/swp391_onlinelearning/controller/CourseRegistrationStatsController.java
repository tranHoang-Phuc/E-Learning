 ...
 * @author phuc2
 */
public class CourseRegistrationStatsController extends BaseRequiredAuthorizationController {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp, AccountDTO user, boolean isActivated, Set<FeatureDTO> features) throws ServletException, IOException {
        ...
        req.setAttribute("totalRegistration", totalRegistration);
        req.setAttribute("totalPage", totalPage);
        
        req.getRequestDispatcher("../view/courseRegistrationStatistics.jsp").forward(req, resp);
    }
