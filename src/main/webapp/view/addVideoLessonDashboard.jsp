...
<html>
    ...
    <body>
        ...
        <div class="right-sider">
            ...
            <div class="addLesson">
                <input type="file" id="fileInp" class="inputFile" accept="video/mp4,video/x-m4v,video/*" onchange="getFile(event)">
                ...
                <form action="editlesson?action=addVideoLesson" id="addLessonForm" method="post">
                    ...
                    function uploadImg() {
                        ...
                        uploadTask.on('state_changed', function (snapshot) {
                            ...
                            uploadTask.snapshot.ref.getDownloadURL().then(function (downloadURL) {
                                document.getElementById('content').value = downloadURL;
                                document.getElementById('addLessonForm').submit();
                            });
                        });
                    }
        </script>
