            ...
            <div class="col-lg-8 m-b30">
                <div class="widget-box">
                    ...
                    <div class="widget-inner" style="margin-left: 50px">
                        ...
                        <form id="answerForm" action="quizlesson" method="post">
                            <c:forEach items="${requestScope.answerList}" var="a">
                                <input class="answer" type="checkbox" name="selectedAnswers" value="${a.answerId}"
                    ...
                    <div class="navigation-button">
                        <c:if test="${index>=2}">
                            <btn class="btn previous-btn"><a href="quizlesson?courseId=${param.courseId}&lessonId=${param.lessonId}&tempId=${requestScope.tempId}&questionId=${requestScope.questionList[requestScope.index-2].questionId}" class="submitLink" onclick="showUrl(this)">Previous Page</a></btn>
                        </c:if>
                                
                        <c:if test="${index < requestScope.questionList.size()}">
                            <btn class="btn next-btn"><a href="quizlesson?courseId=${param.courseId}&lessonId=${param.lessonId}&tempId=${requestScope.tempId}&questionId=${requestScope.questionList[requestScope.index].questionId}" class="submitLink" onclick="showUrl(this)">Next Page</a></btn>
                        </c:if>
            ...
            <div class="col-lg-3 m-b30">
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        ...
                        <a href="quizresult?courseId=${param.courseId}&lessonId=${param.lessonId}&tempId=${requestScope.tempId}" id="finish-attempt" class="submitLink" onclick="showUrl(this)">Finish attempt</a>
                    </div>
                </div>
