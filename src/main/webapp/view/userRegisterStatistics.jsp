                ...
                <div class="col-lg-8 m-b30">
                    <div class="widget-box">
                        ...
                        <div class="widget-inner">
                            ...
                            <c:if test="${requestScope.userList.size()>0 and requestScope.userList ne null}">        
                            ...
                            <c:if test="${requestScope.userList eq null or requestScope.userList.size() <= 0}">
                                <div class="img_not_found">
                                    <img style="width: 300px;" src="../assets/images/404.2 (1).png" alt=""/>
                                </div>
                                <h3 class="not_found">No user registration found!</h3>
                            </c:if>
                        </div>
                    </div>
