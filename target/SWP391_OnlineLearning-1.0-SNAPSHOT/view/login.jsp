    ...
    <body>
        <div class="account-head">
            ...
            <div class="logo-container">
                <a href="http://localhost:8080/SWP391_OnlineLearning/home"><img src="assets/images/logoWhite.png" alt=""></a>
            </div>
        </div>
        <div class="content">
            <div class="heading-box">
                <h2 class="title-head">Login to your <span>Account</span></h2>
                <p class="sub-title">Don't have an account? <a href="register" class="create-account-link">Create one here</a></p>
            </div>
            <form class="contact" action="login" method="post" id="loginForm">
                <div class="form-group">
                    <input name="email" type="text"  value="${requestScope.email}" placeholder="Your Email" class="form-control" id="email" onclick="hideError()">
                </div>
                <div class="form-group">
                    <input id="pass" name="password" type="password" placeholder="Your Password"  onclick="hideError()" class="form-control">
                </div>
                ...
                <div class="form-group form-forget">
                    <div class="custom-control custom-checkbox" style="display:flex;">
                        <input type="checkbox" name="remember" id="customControlAutosizing">
                        <label for="customControlAutosizing">Remember me</label>
                    </div>
                    <a href="forgotPassword" class="forgotPassword">Forgot Password?</a>
                </div>
                <div class="form-group">
                    <button type="button"  class="btn" onclick="sendForm()">Login</button>
                </div>
            </form>
        </div>
        ...
        <script>
            ...
            function hideError() {
                const email = document.getElementById('error');
