            ...
            <div class="col-lg-6 m-b30">
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        ...
                        <p style="text-align: center; font: bold">Chart 1: The chart shows the 5 courses with the most registrations</p>
                        <canvas id="course-registration-piechart" style="width: 200px; height: 100px; margin: 50px;"></canvas>
                        <p style="text-align: center; font: bold">Chart 2: The chart shows the number of registrations by course</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 m-b30">
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        ...
                        <p style="text-align: center; font: bold">Chart 3: The chart shows the 5 blogs with the most views</p>
                        <canvas id="blogview-piechart" style="width: 200px; height: 100px; margin: 50px;"></canvas>
                        <p style="text-align: center; font: bold">Chart 4: The chart shows the number of views by blog</p>
                    </div>
                </div>
            </div>
    </div>
