        ...
        <div class="right-sider">
            ...
            <div class="content">
                <div class="left-customer">
                    <img src="${requestScope.cr.user.img}" alt="" style="border-radius: 50%;">
                    <h4><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${requestScope.cr.user.balance}" /> d</h4>
                    <div> ${requestScope.cr.user.name}</div>
                    <div> ${requestScope.cr.user.account.email}</div>
                    <div> ${requestScope.cr.user.gender==true?"Male":"Female"}</div>
                    <div> ${requestScope.cr.user.phone}</div>
                    <c:if test="${requestScope.cr.user.address!=null}">
                        <div style="border: 1px solid gray"> ${requestScope.cr.user.address}</div>
                    </c:if>
                    <c:if test="${requestScope.cr.user.postCode!=null}">
                        <div style="border: 1px solid gray"> ${requestScope.cr.user.postCode}</div>
                    </c:if>
                </div> 
                <div class="left-course">
                    <div class="cours-bx">
                        <div class="action-box">
                            <img src="${requestScope.cr.course.img}" alt="">
                            <a href="../coursedetail?id=${requestScope.cr.course.courseId}" class="btn">Read More</a>
                        </div>
                        <div class="info-bx text-center">
                            <h5><a href="#">${requestScope.cr.course.name}</a></h5>
                        </div>
                        <div class="cours-more-info">
                            <!--<div class="price">-->
                            <h4><fmt:formatNumber type = "number" maxFractionDigits = "3" value = "${requestScope.cr.course.price}" /> d</h4>
                            <!--</div>-->
                        </div>
                    </div>
                </div>
                    ...
                    <div class="teacher-bx">
                        <div class="teacher-info">
                            <div class="teacher-thumb">
                                <img src="${requestScope.cr.course.author.img}" alt=""/>
                            </div>
                            <div class="teacher-name">
                                <h5>${requestScope.cr.course.author.name}</h5>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div>
                                <ul class="course-features">
                                    <li><i class="ti-book"></i> <span class="label">Category</span> <span class="value">${requestScope.cr.course.category.name}</span></li>
                                    <li><i class="ti-time"></i> <span class="label">Duration</span> <span class="value">${requestScope.cr.course.duration.name}</span></li>
                                    <li><i class="ti-stats-up"></i> <span class="label">Skill level</span> <span class="value">${requestScope.cr.course.level.name}</span></li>
                                    <li><i class="ti-smallcap"></i> <span class="label">Language</span> <span class="value">${requestScope.cr.course.language.name}</span></li>
                                </ul>
                            </div>
                        </div>
                    </div>
