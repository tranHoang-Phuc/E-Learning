        ...
        <header class="header rs-nav">
                            ...
                            <ul>
                                ...
                                <c:if test="${sessionScope.user eq null}">
                                    ...
                                    <c:if test="${sessionScope.user ne null}">
                                        <c:if test="${sessionScope.dtos.size() > 0}">

                                        <li onclick="submit('myForm')" style="cursor: pointer;" >Pay</li>    
                                        </c:if>
            ...
            <c:if test="${sessionScope.dtos.size() > 0}">
                <form action="pay" method="post" id="myForm">
                    ...
                    <c:forEach items="${sessionScope.dtos}" var="c">
                    ...
                    <c:if test="${pageScope.price <= sessionScope.user.balance}">
                        <input type="hidden" name="amount" value="${sessionScope.user.balance - pageScope.price}">
                    </c:if>
